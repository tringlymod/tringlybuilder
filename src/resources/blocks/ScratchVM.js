...
function register() {
    //is mouse down?
    registerBlock(`${categoryPrefix}mousedown`, {
    ...
    //logged in?
    registerBlock(`${categoryPrefix}loggedin`, {
        message0: `logged in?`,
        args0: [],
        ...
        return [`Scratch.vm.runtime.ioDevices.userData.getLoggedIn()`, javascriptGenerator.ORDER_ATOMIC];
    ...
    registerBlock(`${categoryPrefix}ispenguinmod`, {
        ...
        return [`Boolean(Scratch.extensions.isPenguinMod)`, javascriptGenerator.ORDER_ATOMIC];
    })
};
