...
function register() {
    ...
    // undefined
    registerBlock(`${categoryPrefix}undefined`, {
        message0: 'undefined',
        args0: [],
        output: "Undefined",
        inputsInline: true,
    ...
    registerBlock(`${categoryPrefix}boolean`, {
        ...
        const CHECK = block.getFieldValue('CHECK').toLowerCase()

        const code = (BOOLEAN == "CHECK" ? `${CHECK}` : `(Math.random() >= 0.5)`)
    ...
    // plain text
    registerBlock(`${categoryPrefix}plaintext`, {
        message0: "plain %1",
        args0: [
            {
                "type": "field_input",
    ...
    registerBlock(`${categoryPrefix}string`, {
        ...
        return [`${STRINGTYPE}${STRING}${STRINGTYPE}`, javascriptGenerator.ORDER_ATOMIC];
    })

    // parenthesis
    registerBlock(`${categoryPrefix}parenthesis`, {
        message0: "( %1 )",
        args0: [
            {
                "type": "input_value",
    ...
    // blank array
    registerBlock(`${categoryPrefix}blankarray`, {
    ...
    // blank object
    registerBlock(`${categoryPrefix}blankobject`, {
